    ...
    public static List<Car> createCars() {
     return Arrays.asList(
        ...
        Car.builder()
           ...
           .build(),
            Car.builder().make("Ford").year(1988).mileage(16124.3)
                .defects(Arrays.asList("shift knob loose", "short in steering column", "spontaneous combustion", "rust")).build(),
            Car.builder().make("Ford").year(1974).mileage(200000.0)
                .defects(Arrays.asList("can see road through rust hole",
                                       "plastic bags in trunk to keep water out",
                                       "Maverick enough said")).build()
        );
    }
}
