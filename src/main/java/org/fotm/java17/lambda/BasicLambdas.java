...
/**
 * Solutions to BasicLambdas Assignment
 * by Sean Kennedy
 */
...
interface PrintableSolution<T> {
    void print(T t); // similar to Consumer
}

interface RetrievableSolution<T> {
    T retrieve();// similar to Supplier
}

interface EvaluateSolution<T> {
    boolean isNegative(T t);// similar to Predicate
}

interface FunctionableSolution<T, R> {
...
//        listPeople.forEach(person -> System.out.println(person)); // lambda
    ...
    public void consumer() {
        ...
        PrintableSolution<String> lambda = s -> System.out.println(s);
    ...
    public void supplier() {
        ...
        RetrievableSolution<Integer> lambda = () -> 77;
    ...
    public void predicate() {
        ...
        EvaluateSolution<Integer> lambda = i -> i < 0;
    ...
    public void function() {
        ...
        FunctionableSolution<Integer, String> lambda = i -> "Number is: " + i;
